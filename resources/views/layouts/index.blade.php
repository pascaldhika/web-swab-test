                        ...
                        if(data.success){
                          ...
                          $.each(data.data, function (k, v) {
                            switch(v.status) {
                              ...
                              case 'Reaktif':
                                sts2 = "<option value='Reaktif' selected>Reaktif</option>
                                <option value='Non Reaktif'>Non-Reaktif</option>";
                                break;

                              case 'Nonreaktif':
                                sts2 = "<option value='Reaktif'>Reaktif</option>
                                <option value='Non Reaktif' selected>Non-Reaktif</option>";
                                break;

                              default:
                                if (type == 'Antibodi Test'){
                                    sts2 = "<option value='Positif'>Positif</option>
